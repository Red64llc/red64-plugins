...
- [x] 1.0 Complete configuration schema extension for standards support
  - [x] 1.1 Write 4-6 focused tests for config schema and utilities
  ...
  - [x] 1.2 Extend `plugins/core/scripts/config_schema.py` with Standards section
...
- [x] 2.0 Complete standards plugin template structure
  - [x] 2.1 Write 3-5 focused tests for plugin template validation
  ...
  - [x] 2.2 Create standards template directory at `plugins/standards-template/`
  ...
  - [x] 2.3 Create `plugins/standards-template/standards.json` manifest
    - Define `file_patterns` array for file type matching (e.g., `["*.ts", "*.tsx"]`)
    - Include `name` and `description` fields for identification
  - [x] 2.4 Create `plugins/standards-template/skills/` directory with example skill
  ...
  - [x] 2.5 Create `plugins/standards-template/hooks/` directory with empty `hooks.json`
    - Standards plugins use core validator hook, not custom hooks
    - Include empty hooks.json: `{"hooks": {}}`
  - [x] 2.6 Ensure plugin template tests pass
...
- [x] 3.0 Complete CLI commands for standards management
  - [x] 3.1 Write 4-6 focused tests for standards commands
  ...
  - [x] 3.2 Create `plugins/core/commands/red64-standards-enable.md`
  ...
  - [x] 3.3 Create `plugins/core/commands/red64-standards-disable.md`
    - Follow command format from `red64-init.md` template
  ...
  - [x] 3.4 Create `plugins/core/commands/red64-standards-list.md` (optional utility)
  ...
  - [x] 3.5 Ensure CLI command tests pass
...
- [x] 4.0 Complete PreToolUse hook infrastructure for standards validation
  - [x] 4.1 Write 5-8 focused tests for standards validator hook
  ...
  - [x] 4.2 Update `plugins/core/hooks/hooks.json` with PreToolUse configuration
  ...
  - [x] 4.3 Create `plugins/core/hooks/standards-validator.py` script
  ...
  - [x] 4.4 Implement blocking capability in validator
  ...
  - [x] 4.5 Add standards skill loading utility function
  ...
  - [x] 4.6 Ensure hook infrastructure tests pass
...
- [x] 5.0 Complete context loader integration for standards skills
  - [x] 5.1 Write 4-6 focused tests for context loader standards integration
  ...
  - [x] 5.2 Extend `plugins/core/scripts/context-loader.py` for standards loading
  ...
  - [x] 5.3 Update `format_additional_context()` function
  ...
  - [x] 5.4 Integrate with budget manager for token allocation
  ...
  - [x] 5.5 Create standards skill loader utility script
  ...
  - [x] 5.6 Ensure context loader integration tests pass
...
- [x] 6.0 Complete TypeScript reference standards plugin
  - [x] 6.1 Write 4-6 focused tests for TypeScript standards plugin
  ...
  - [x] 6.2 Create plugin directory at `plugins/red64-standards-typescript/`
  ...
  - [x] 6.3 Create `plugins/red64-standards-typescript/standards.json`
    - Set file patterns: `["*.ts", "*.tsx"]`
    - Include plugin name and description
  - [x] 6.4 Create `skills/naming-conventions.md`
  ...
  - [x] 6.5 Create `skills/type-safety.md`
  ...
  - [x] 6.6 Create `skills/error-handling.md`
  ...
  - [x] 6.7 Create `skills/module-structure.md`
  ...
  - [x] 6.8 Create `skills/async-patterns.md`
  ...
  - [x] 6.9 Create `plugins/red64-standards-typescript/hooks/hooks.json`
    - Empty hooks file: `{"hooks": {}}`
    - Standards use core validator hook
  - [x] 6.10 Ensure TypeScript plugin tests pass
...
- [x] 7.0 Review existing tests and verify full integration
  ...
  - [x] 7.2 Analyze test coverage gaps for standards feature
  ...
  - [x] 7.5 Verify complete integration
