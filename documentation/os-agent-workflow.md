...
cf: [plan-product](https://buildermethods.com/agent-os/plan-product)
...
cf: [shape-spec](https://buildermethods.com/agent-os/shape-spec)

## 2 Write spec
The write-spec command transforms your requirements into a detailed specification document.
cf: [write-spec](https://buildermethods.com/agent-os/write-spec)
...
cf: [create-tasks](https://buildermethods.com/agent-os/create-tasks)
...
cf: [implement-task](https://buildermethods.com/agent-os/implement-tasks)
...
cf: [orchestrate-tasks](https://buildermethods.com/agent-os/orchestrate-tasks)